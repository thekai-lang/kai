...
// -- v0.0.6 (§9.9a/§9.10) -------------------------------------------------------
//
// NOTE on Result coverage: pure Kai source cannot CONSTRUCT a `Result`
// value yet — the grammar has no Ok/Err literals (§3.4's examples come from
// stdlib, which ships in a later version). Catch/unwrap_or-on-Result share
// their typing codepath with the Optional forms exercised here; end-to-end
// Result flow gets covered once a constructor exists.
